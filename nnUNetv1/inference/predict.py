...
from nnunet.utilities.bp_nnunet import check_bp_nnunet, nnunetv1_get_subject_name, to_meta_tensor
...
def predict_cases(model, list_of_lists, output_filenames, folds, save_npz, num_threads_preprocessing,
    ...
    for preprocessed in preprocessing:
        ...
        if check_bp_nnunet():
            name = nnunetv1_get_subject_name(output_filename)
            d = to_meta_tensor(d, name)
