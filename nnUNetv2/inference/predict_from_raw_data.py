...
from nnunetv2.utilities.bp_nnunet import check_bp_nnunet, get_embeddings, load_blood_pressure, get_blood_pressure, to_meta_tensor, MetaTensor
...
class nnUNetPredictor(object):
    def __init__(self,
        ...
        # BP-nnUNet: Required variables to store blood pressure and embeddings
    ...
    def initialize_from_trained_model_folder(self, model_training_output_dir: str,
        ...
        # BP-nnUNet: Custom build_network_architecture
        if check_bp_nnunet():
            network = trainer_class._build_network_architecture(
        ...
        # BP-nnUNet: Load blood pressure and text embeddings in advance
        if check_bp_nnunet():
    ...
    def predict_from_data_iterator(self,
        ...
        with multiprocessing.get_context("spawn").Pool(num_processes_segmentation_export) as export_pool:
            ...
            for preprocessed in data_iterator:
                ...
                # BP-nnUNet: Extract subject name and convert to MetaTensor
                if check_bp_nnunet():
                    name = os.path.basename(ofile)
                    data = to_meta_tensor(data, name, self.bp, self.embeds)
